...
protected:
...
#endif
#if( FMI_SUPPORT_A609 )
    afx_msg void OnUpdateFileRebootDevice
        (
        CCmdUI * aCmdUI
        );
...
#endif
#if( FMI_SUPPORT_A610 )
    afx_msg void OnUpdateFileAOBRDDrivers
        (
        CCmdUI * aCmdUI
        );
    ...
    //! Used in conjunction with mRemainingRates to cycle through available rates
    //!   when initializing communication
