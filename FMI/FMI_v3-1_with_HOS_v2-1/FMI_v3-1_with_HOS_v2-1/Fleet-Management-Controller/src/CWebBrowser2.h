...
//----------------------------------------------------------------------
//! \brief Web Browser ActiveX wrapper, generated by Visual Studio
//! \details This class exposes methods from IWebBrowser2 from the
//!     Microsoft ActiveX component library and can be used to embed a
//!     browser into a dialog for rendering HTML and basic navigation
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
//! \brief translate escape sequences into their original characters
//! \details This takes an encoded URL and produces a plain-text version
//!    which is useful for parsing the location URL of a browser control
//----------------------------------------------------------------------
    static CString URLDecode(CString sIn);

//----------------------------------------------------------------------
//! \brief escape any special characters for use in URLs
//! \details This takes an plain-text string and replaces several
//!    special characters with escape sequences that can be interpreted
//!    by a URL handler
//----------------------------------------------------------------------
